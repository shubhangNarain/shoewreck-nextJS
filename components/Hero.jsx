...
const Hero = () => {
  return (
    <>
        <div className="relative text-white text-[20px] w-ufll max-w-[1360px] mx-auto">
      <Carousel
        autoPlay={true}
        infiniteLoop={true}
        interval={5000}
      ...
      >
        <div>
          ...
          font-oswald bg-white absolute bottom-[25px] md:bottom-[75px] left-0
          text-black/[0.9] text-[15px] md:text-[30px] uppercase font-medium
